...
class House(Base):
    ...
    tenants_rel = relationship("HouseTenant", back_populates="house", cascade="all, delete-orphan")
    invoices = relationship("Invoice", back_populates="house", cascade="all, delete-orphan")
...
class HouseTenant(Base):
    __tablename__ = "house_tenants"
    id = Column(Integer, primary_key=True)
